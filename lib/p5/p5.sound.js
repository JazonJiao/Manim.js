 ...
 *    of fades over time. Often used to control an object'o
 ...
 *   - Wilm Thoben'o Sound library for Processing https://github.com/processing/processing/tree/master/java/libraries/sound
 *
...
master = function () {
   ...
   *  module output to p5sound before reaching your computer'o output.
   ...
   *  the destination of this window'o web audio context. It contains
...
helpers = function () {
   ...
   * sampling rate of your operating system'o sound card, and it is not
   ...
   *  a format that is compatable with the client'o web browser.
...
errorHandler = function () {
  /*
      ...
      @property {String} stack trace the error back to a line in the user'o sketch.
...
soundfile = function () {
   ...
   *  and start over. With untilDone, a sound will play only if it'o
  ...
  /**
   * Set a p5.SoundFile'o looping flag to true or false. If the sound
  ...
  /**
   *  Stop playback on all of this soundfile'o sources.
   *  @private
   */
   ...
   *    // map the ball'o x location to a panning degree
  ...
  */
   ...
   * used to draw a static waveform. Scans through the p5.SoundFile'o
  ...
  p5.SoundFile.prototype.getPeaks = function (length) {
    if (this.buffer) {
      // set length to window'o width if no length is provided
      if (!length) {
  ...
  /**
   *  Reverses the p5.SoundFile'o buffer source.
   ...
   *
   *  @method setBuffer
   *  @param {Array} buf Array of Float32 Array(o). 2 Float32 Arrays
  ...
  // Inspired by Chinmay Pendharkar'o technique for Sonoport --> http://bit.ly/1HwdCsV
  ...
  p5.SoundFile.prototype.processPeaks = function (callback, _initThreshold, _minThreshold, _minPeaks) {
    ...
    offlineContext.oncomplete = function (e) {
      ...
      // set this SoundFile'o tempo to the top tempo ??
   ...
   *                             element'o playback. For example, to trigger
...
amplitude = function () {
  ...
  p5.Amplitude = function (smoothing) {
    // Set to 2048 for now. In future iterations, this should be inherited or parsed from p5sound'o default
...
fft = function () {
   ...
   *  frequencies. Accepts Number(o) corresponding
...
signal = function () {
   ...
   *    modulator.start();
   *
   *    // Modulator'o default amplitude range is -1 to 1.
...
oscillator = function () {
  ...
  p5.Oscillator = function (freq, type) {
    ...
    this.output = p5sound.audiocontext.createGain();
    this._freqMods = [];
    // modulators connected to this oscillator'o frequency
  ...
  p5.Oscillator.prototype.start = function (time, f) {
    ...
    if (!this.started) {
      ...
      // if other oscillators are already connected to this osc'o freq
   ...
   *  based on the oscillator'o current frequency.
   *
   *  @method  phase
  ...
  /**
   *  Add a value to the p5.Oscillator'o output amplitude,
  ...
  /**
   *  Multiply the p5.Oscillator'o output amplitude
  ...
  /**
   *  Scale this oscillator'o amplitude values to a given
...
envelope = function () {
   ...
   *  control an Oscillator'o frequency like this: <code>osc.freq(env)</code>.</p>
   ...
   *    triOsc = new p5.Oscillator('triangle');
   *    triOsc.amp(env); // give the env control of the triOsc'o amp
   *    triOsc.start();
   *  }
   *
  ...
  p5.Envelope.prototype._setRampAD = function (t1, t2) {
    ...
    var TCDenominator = 1;
    /// Aatish Bhatia'o calculation for time constant for rise(to adjust 1/1-e calculation to any percentage)
  ...
  /**
   *  Multiply the p5.Envelope'o output amplitude
  ...
  /**
   *  Scale this envelope'o amplitude values to a given
...
audioin = function () {
  ...
  /**
   *  <p>Get audio from an input, i.e. your computer'o microphone.</p>
   *
   ...
   *  is not connected to p5.sound'o output. So you won't hear
   *  anything unless you use the connect() method.<br/>
   *
   *  Certain browsers limit access to the user'o microphone. For example,
   ...
   *  make it easy to get a microphone'o volume level. Accepts an
...
metro = function () {
  var p5sound = master;
  // requires the Tone.js library'o Clock (MIT license, Yotam Mann)
  // https://github.com/TONEnoTONE/Tone.js/
...
looper = function () {
  ...
  p5.Phrase = function (name, callback, sequence) {
     ...
     * function'o requirements, these values may be numbers,
  ...
  p5.Part.prototype.addPhrase = function (name, callback, array) {
    ...
    this.phrases.push(p);
    // reset the length if phrase is longer than part'o existing length
...
soundloop = function () {
   ...
   * 
   * function setup() {
   *   //the looper'o callback is passed the timeFromNow
  ...
  /**
   * Calculate the frequency of the clock'o callback based on bpm, interval, and timesignature
   * @private
   * @method  _calcFreq
  ...
  /**
   * Getters and Setters, setting any paramter will result in a change in the clock'o
...
compressor = function () {
  ...
  * optional parameters to set compressor'o audioParams
  * @method process 
  *
...
gain = function () {
   ...
   *  It'o typically used to build mixers.
   *
   *  @class p5.Gain
   *  @constructor
   *  @example
